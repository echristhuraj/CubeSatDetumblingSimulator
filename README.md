...
* The user should adjust the `<frmeRte_simUI>` and `<simSpdMltplr>` parameters such that aliasing, graphical errors, or other issues do not occur as to make the simulation results diverge or the program to crash.
