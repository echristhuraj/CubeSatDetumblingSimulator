...
simProcssngMdfier = 'Pre-Calculate'; %*Range: 'Real-Time' or 'Pre-Calculate'*
...
switch simProcssngMdfier
    ...
    otherwise
        set(simUI, 'Visible', 'off');
        error('The value assigned to simProcssngMdfier may be spelled incorrectly.');
end
