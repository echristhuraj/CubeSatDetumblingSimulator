...
bDotCntrllrGain_xMgntrqr = 10000; %[unitless] *Range: bDotCntrllrGain_xMgntrqr ≥ 0*
bDotCntrllrGain_yMgntrqr = 10000; %[unitless] *Range: bDotCntrllrGain_yMgntrqr ≥ 0*
bDotCntrllrGain_zMgntrqr = 10000; %[unitless] *Range: bDotCntrllrGain_zMgntrqr ≥ 0*
numCoils_xMgntrqr = 12000; %[unitless] *Range: numCoils_xMgntrqr > 0*
numCoils_yMgntrqr = 12000; %[unitless] *Range: numCoils_yMgntrqr > 0*
numCoils_zMgntrqr = 320; %[unitless] *Range: numCoils_zMgntrqr > 0*
sctnArea_xMgntrqr = 2.2698E-4; %[m^2] *Range: sctnArea_xMgntrqr > 0*
sctnArea_yMgntrqr = 2.2698E-4; %[m^2] *Range: sctnArea_yMgntrqr > 0*
sctnArea_zMgntrqr = 8.7695E-3; %[m^2] *Range: sctnArea_zMgntrqr > 0*
maxCrrnt_xMgntrqr = 0.2143; %[A] *Range: maxCrrnt_xMgntrqr > 0*
maxCrrnt_yMgntrqr = 0.2143; %[A] *Range: maxCrrnt_yMgntrqr > 0*
maxCrrnt_zMgntrqr = 0.2135; %[A] *Range: maxCrrnt_zMgntrqr > 0*

%Magnetometer Parameters
lpFltrGain_mgntmtr = 0.4; %[unitless] *Range: 0 ≤ lpFltrGain_mgntmtr ≤ 1*
sampRte_mgntmtr = 2; %[Hz] *Range: sampRte_mgntmtr > 0*
cnstntBiasVctr_mgntmtr = [0; 0; 0]; %[T] *Range: cnstntBiasVctr_mgntmtr ≥ [0; 0; 0]*
maxNoiseAmpltde_mgntmtr = 1E-6; %[T] *Range: maxNoiseAmpltde_mgntmtr ≥ 0*

%Gyroscope Parameters
lpFltrGain_gyro = 0.45; %[unitless] *Range: 0 ≤ lpFltrGain_gyro ≤ 1*
sampRte_gyro = 50; %[Hz] *Range: sampRte_gyro > 0*
cnstntBiasVctr_gyro = [0; 0; 0]; %[deg/s] *Range: cnstntBiasVctr_gyro ≥ [0; 0; 0]*
maxNoiseAmpltde_gyro = 0.25; %[deg/s] *Range: maxNoiseAmpltde_gyro ≥ 0*

%Spacecraft Parameters
mass_spcrft = 2.6; %[kg] *Range: mass_spcrft > 0*
dimnsnsX_spcrft = 0.1; %[m] *Range: dimnsnsX_spcrft > 0*
dimnsnsY_spcrft = 0.1; %[m] *Range: dimnsnsY_spcrft > 0*
dimnsnsZ_spcrft = 0.2; %[m] *Range: dimnsnsZ_spcrft > 0*
...
dsirdBdyAnglrRteX_spcrft = 0; %[deg/s] *Range: dsirdBdyAnglrRteX_spcrft ≥ 0*
dsirdBdyAnglrRteY_spcrft = 0; %[deg/s] *Range: dsirdBdyAnglrRteY_spcrft ≥ 0*
dsirdBdyAnglrRteZ_spcrft = 0; %[deg/s] *Range: dsirdBdyAnglrRteZ_spcrft ≥ 0*

%Orbit Parameters
alt_orbt = 6E5; %[m] *Range: 2E6 < alt_orb < 8.5E6*
inc_orbt = 97.787; %[deg] *Range: 0 ≤ inc_orb ≤ 180*
aop_orbt = 144.8873; %[deg] *Range: 0 ≤ aop_orb < 360*
raan_orbt = 59.4276; %[deg] *Range: 0 ≤ raan_orb < 360*
numOrbts = 1; %[unitless] *Range: numOrbs > 0*

%Simulator UI Parameters
scrnScleFctr_simUI = 0.75; %[unitless] *Range: 0 < scrnScleFctr_simUI ≤ 1*
frmeRte_simUI = 10; %[fps] *Range: frmeRte_simUI < 15*
simSpdMltplr = 50; %[unitless] *Range: simSpdMltplr > 0*
viewAzmth = 135; %[deg] *Range: 0 ≤ viewAzmth < 360*
viewElvtn = 22.5; %[deg] *Range: 0 ≤ viewElvtn < 360*
...
if (ishghandle(simUI))
    ...
    disp("Real Elapsed Time (s): " + (numOrbts * period_orbt));
